...
@javax.annotation.Generated(
    ...
    comments = "Source: SmartHomePing.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class StreamingClientServiceGrpc {

  private StreamingClientServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "StreamingClientService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.CA.gRPC.UnaryRequest,
      com.CA.gRPC.UnaryResponse> getSendUnaryRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendUnaryRequest",
      requestType = com.CA.gRPC.UnaryRequest.class,
      responseType = com.CA.gRPC.UnaryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.CA.gRPC.UnaryRequest,
      com.CA.gRPC.UnaryResponse> getSendUnaryRequestMethod() {
    io.grpc.MethodDescriptor<com.CA.gRPC.UnaryRequest, com.CA.gRPC.UnaryResponse> getSendUnaryRequestMethod;
      ...
      synchronized (StreamingClientServiceGrpc.class) {
        if ((getSendUnaryRequestMethod = StreamingClientServiceGrpc.getSendUnaryRequestMethod) == null) {
          StreamingClientServiceGrpc.getSendUnaryRequestMethod = getSendUnaryRequestMethod =
              io.grpc.MethodDescriptor.<com.CA.gRPC.UnaryRequest, com.CA.gRPC.UnaryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendUnaryRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.UnaryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.UnaryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.CA.gRPC.ClientInformation,
      com.CA.gRPC.ServerResponse> getStreamClientInformationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamClientInformation",
      requestType = com.CA.gRPC.ClientInformation.class,
      responseType = com.CA.gRPC.ServerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.CA.gRPC.ClientInformation,
      com.CA.gRPC.ServerResponse> getStreamClientInformationMethod() {
    io.grpc.MethodDescriptor<com.CA.gRPC.ClientInformation, com.CA.gRPC.ServerResponse> getStreamClientInformationMethod;
      ...
      synchronized (StreamingClientServiceGrpc.class) {
        if ((getStreamClientInformationMethod = StreamingClientServiceGrpc.getStreamClientInformationMethod) == null) {
          StreamingClientServiceGrpc.getStreamClientInformationMethod = getStreamClientInformationMethod =
              io.grpc.MethodDescriptor.<com.CA.gRPC.ClientInformation, com.CA.gRPC.ServerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamClientInformation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.ClientInformation.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.ServerResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sendUnaryRequest(com.CA.gRPC.UnaryRequest request,
        io.grpc.stub.StreamObserver<com.CA.gRPC.UnaryResponse> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.CA.gRPC.ClientInformation> streamClientInformation(
        io.grpc.stub.StreamObserver<com.CA.gRPC.ServerResponse> responseObserver) {
  ...
  public static final class StreamingClientServiceStub
     ...
     * </pre>
     */
    public void sendUnaryRequest(com.CA.gRPC.UnaryRequest request,
        io.grpc.stub.StreamObserver<com.CA.gRPC.UnaryResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.CA.gRPC.ClientInformation> streamClientInformation(
        io.grpc.stub.StreamObserver<com.CA.gRPC.ServerResponse> responseObserver) {
  ...
  public static final class StreamingClientServiceBlockingStub
     ...
     * </pre>
     */
    public com.CA.gRPC.UnaryResponse sendUnaryRequest(com.CA.gRPC.UnaryRequest request) {
  ...
  public static final class StreamingClientServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.CA.gRPC.UnaryResponse> sendUnaryRequest(
        com.CA.gRPC.UnaryRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_UNARY_REQUEST:
          serviceImpl.sendUnaryRequest((com.CA.gRPC.UnaryRequest) request,
              (io.grpc.stub.StreamObserver<com.CA.gRPC.UnaryResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.CA.gRPC.UnaryRequest,
              com.CA.gRPC.UnaryResponse>(
                service, METHODID_SEND_UNARY_REQUEST)))
        .addMethod(
          getStreamClientInformationMethod(),
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.CA.gRPC.ClientInformation,
              com.CA.gRPC.ServerResponse>(
  ...
  private static abstract class StreamingClientServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.CA.gRPC.PingProto.getDescriptor();
    }
