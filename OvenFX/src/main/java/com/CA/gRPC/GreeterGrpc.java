...
/**
 * <pre>
 *Service definition - Unary RPC
 * </pre>
 */
@javax.annotation.Generated(
    value = "by gRPC proto compiler (version 1.61.1)",
    comments = "Source: WelcomeMsg.proto")
...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.CA.gRPC.HelloRequest,
      com.CA.gRPC.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.CA.gRPC.HelloRequest.class,
      responseType = com.CA.gRPC.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.CA.gRPC.HelloRequest,
      com.CA.gRPC.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.CA.gRPC.HelloRequest, com.CA.gRPC.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.CA.gRPC.HelloRequest, com.CA.gRPC.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.CA.gRPC.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.CA.gRPC.HelloRequest request,
        io.grpc.stub.StreamObserver<com.CA.gRPC.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(com.CA.gRPC.HelloRequest request,
        io.grpc.stub.StreamObserver<com.CA.gRPC.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public com.CA.gRPC.HelloReply sayHello(com.CA.gRPC.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.CA.gRPC.HelloReply> sayHello(
        com.CA.gRPC.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.CA.gRPC.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.CA.gRPC.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.CA.gRPC.HelloRequest,
              com.CA.gRPC.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.CA.gRPC.WelcomeMsgProto.getDescriptor();
    }
